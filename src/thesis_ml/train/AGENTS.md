...
- Optimizer/schedule/checkpoint fields (`lr`, `betas`, `weight_decay`, schedule/phase ratios, `lr_floor`, `grad_clip`, accumulation, precision, epochs, early stopping, cadence, and family subdirectories) are config-owned. Derived step horizons divide dataloader batches by fixed accumulation.
