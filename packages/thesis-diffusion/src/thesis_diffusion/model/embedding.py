...
from thesis_diffusion.model.backbone import GeGLU, RMSNorm
...
class InputFeatures:
    ...
    ``thesis_diffusion.data.collate``), instead of re-parsing TokenRecord objects in a
    ...
    def __init__(
        ...
        *,
        ...
        Calls: nn.Embedding/nn.Linear/nn.Sequential construction plus RMSNorm
            and GeGLU from thesis_diffusion.model.backbone. Zero-initialization of the
