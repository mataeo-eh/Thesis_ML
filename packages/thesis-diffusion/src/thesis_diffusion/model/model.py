...
from thesis_shared.config import ProjectConfig, toggle_fingerprint
from thesis_shared.data.feature_stats import FeatureStatistics
from thesis_diffusion.model.backbone import BidirectionalTransformer, FrozenInputKV, RMSNorm
from thesis_diffusion.model.embedding import InputContextEmbedding, InputFeatures
...
# and it is credited as such in research/, but the architecture here
...
class ModelOutput:
    ...
    # `frozen_input_kv` to be enabled (now the default).
