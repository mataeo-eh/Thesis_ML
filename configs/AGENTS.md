...
- `smallTrainingTestV3.yaml` overrides the inherited microbatch to 6 and accumulates 7 microbatches: 42 windows and about 275k valid tokens per optimizer step on the measured real-data slice. Its 6.5 GiB reclaim ceiling is above the healthy ~5.0 GiB reservation and leaves room for Windows/display allocations on the 8 GiB RTX 3070.
